...
namespace KouveePetShop
{
    partial class Login : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM `pegawai` WHERE `nama_pegawai` = @usn and `kata_sandi` = @pass", db.getConnection());
            ...
            {
                this.Hide();
                halamanOwner halOwner = new halamanOwner();
                halOwner.Show();
